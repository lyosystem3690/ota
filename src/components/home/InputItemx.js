...
async function elllamdo() {  
 ...
 //  alert("s")
    ...
    let urls3 =  'http://127.0.0.1:8001/visiblecorrectxcent?address='+account;
    axios(urls3, {
          method: 'GET',
      }).then(response => {
       ...
       //   alert(geturl3)
          ...
          if(geturl3 == 0 && response.data == 0){
             window.history.back();
                          ...
                          //let urls2 =  'https://stake.1centdream.online/visiblecorrect1cent?address='+account;
    let urls3 =  'https://stake.1centdream.online/visiblecorrectxcent?address='+account;
    axios(urls3, {
          method: 'GET',
      }).then(response => {
  ...
  //   alert(geturl3)
    ...
    const onSubmit = e => {
        e.preventDefault()
            stakeTokensx(precio,precio,procentaje,time) 
    }
    ...
    return (
        ...
        <div>
            ...
            <div>
                ...
                <label htmlFor="search" className="block text-sm font-medium text-gray-700"><b>Staking Xcent : </b>{precio2} Xcent Receive in your wallet at the end of staking . <b className="text-red-1000">{calculo2} Xcent</b><br></br> <b> Time in Staking</b>:   {mount} mount <b></b><br></br> <b> Percentage staking : </b> {procentaje} %  </label>    
                </label>
...
{acotres2==='S' && (
   ...
   <img src="https://cdn-icons-png.flaticon.com/512/5390/5390264.png" alt="imagen" style={{width: 50}}></img> <b> Thanks for your Staking the XCent, remember wait date for win recompense</b>
   <br></br>
 </div>
  ...
  {acotres2==='SS' && (
     <div className="inline-flex items-center justify-center">
 <b> Please wait for 1 to 7 days for return XCent your Wallet, remember that a 10% fine will be charged for not complying with the agreed time. Receive in your wallet  {dollarUSLocale.format(acotres4 - 28 * acotres4 / 100 ) } XCent</b>
   <br></br>
 </div>
            ...
            {precios>1  && (
               <span>  <b>Please confirm deposit 1Cent </b> : {dollarUSLocale.format(precios)}  </span>
                ...
                <label htmlFor="search" className="block text-sm font-medium text-gray-700"><b>Win 1Cent : </b>{dollarUSLocale.format(precio3)} 1Cent  - Receive in your wallet at the end of staking .<b> {dollarUSLocale.format(precio3 - precio3 * 10 /100)} 1Cent </b></label>
