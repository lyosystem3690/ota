    ...
    return (
        ...
        <div>
            ...
            <div>
                ...
                <label htmlFor="search" className="block text-sm font-medium text-gray-700"><b>Staking 1CEnt : </b>{precio2} <br></br> <b> Time in Staking</b>   {mount} mount <b></b><br></br> <b> Percentage staking  </b> {time} %  </label>    
                </label>
