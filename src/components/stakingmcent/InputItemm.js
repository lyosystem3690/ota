    ...
    return (
        ...
        <div>
            ...
            <div>
                ...
                <label htmlFor="search" className="block text-sm font-medium text-gray-700"><b>Staking MCEnt : </b>{precio2} <br></br> <b> Time in Staking</b>   {mount} mount <b></b><br></br> <b> Percentage staking  </b> {time} %  </label>    
                </label>
   ...
   <br></br>
            ...
            {precios>1  && (
               <span>  <b>Please confirm deposit 1Cent </b> : {dollarUSLocale.format(precios)}  </span>
                ...
                <label htmlFor="search" className="block text-sm font-medium text-gray-700"><b>Win XCEnt : </b>{dollarUSLocale.format(precio3)}  </label>
